        ...
        {friendRequests.length === 0 ? (
            ...
            friendRequests.map((request) => (
                ...
                >
                    ...
                    <button onClick={() => acceptFriend(request.senderId)} aria-label='Accept friend' className='w-8 h-8 bg-[#72cab7] hover:bg-[#559084] grid place-items-center rounded-full transition hover:shadow-md'>
